...
taskNameInput.addEventListener("change",checkDisplayTaskNameInput);

let listTable = document.querySelector("listTable");

function checkDisplayTaskNameInput()
{
        ...
        .then(function (response) {
            ...
            else
            {
              ...
              for(let key in data)
              {
                ...
                let successText = document.querySelector("#displayTaskSuccessText").innerHTML = `Task(s) with name :  ${finalTaskNameString} found!`;
...
document.querySelector("button#displayTaskButton").addEventListener("click", displayTaskByName);
